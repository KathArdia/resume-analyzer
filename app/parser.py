...
def parse_vacancies(vacancy, technologies, days=30):
    ...
    # Сохранение топ-10 технологий в JSON
    requirements_data = {
        "job_keywords": [tech for tech, _ in tech_summary[:10]]
    }
    file_name = r"C:\\Users\\Athur\\resume-analyzer\\notebooks\\requirements.json"
    with open(file_name, "w", encoding="utf-8") as file:
        json.dump(requirements_data, file, ensure_ascii=False, indent=4)
    
    print(f"\nФайл с топ-10 технологий сохранён с именем: {file_name}")
